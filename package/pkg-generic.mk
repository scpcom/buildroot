...
$(BUILD_DIR)/%/.stamp_installed:
	...
	elif [ "X$(findstring $($(PKG)_NAME), alsa-lib avahi bind harfbuzz icu libnl libselinux pcre2 python3 tcl util-linux host-icu host-libselinux host-pcre2 host-python3 host-util-linux)" = "X" ]; then \
		rm -Rf $(@D)/*/ ; \
	fi
	$(Q)touch $@
